...
// The delay parameter is in units of the core clock. (units of 10.416666 nsec for 120 MHz clock)
...
void SysTick_Wait10ms(uint32_t delay){
  uint32_t i;
  for(i=0; i<delay; i++){
    SysTick_Wait(800000);  // wait 10ms (80 MHz clock meaning 80*10000 = 800000)
  }
}

void SysTick_Wait1ms(uint32_t delay){ // new function for 1ms!
  uint32_t i;
  for(i=0; i<delay; i++){
    SysTick_Wait(80000);  // wait 1ms (80 MHz clock with 80000 cycles equals 1ms)
  }
}
...
void SysTick_Wait1us(uint32_t delay){
  uint32_t i;
  for(i=0; i<delay; i++){
    SysTick_Wait(80);  // change this to wait 10us (80 MHz clock meaning 80)
  }
}